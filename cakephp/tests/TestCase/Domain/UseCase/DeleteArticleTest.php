...
use App\Domain\UseCase\DeleteArticle;
...
class DeleteArticleTest extends TestCase
{
    ...
    public function testInvoke(): void
    {
        ...
        // deleteArticle メソッドが1回呼ばれることを期待
        $articlesServiceMock->expects($this->once())
            ->method('deleteArticle')
            ->willReturn(true);

        // UseCaseを作成
        $useCase = new DeleteArticle($articlesServiceMock);
    ...
    public function testInvokeError(): void
    {
        ...
        // deleteArticle メソッドが1回呼ばれ、空の配列を返すことを期待
        $articlesServiceMock->expects($this->once())
            ->method('deleteArticle')
            ->willReturn(false);
    ...
    public function testInvokeServiceError(): void
    {
        ...
        // deleteArticle メソッドが例外を投げることを期待
        $articlesServiceMock->expects($this->once())
            ->method('deleteArticle')
